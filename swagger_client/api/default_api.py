...
class DefaultApi(object):
    ...
    def requests_request_id_options(self, request_id, **kwargs):  # noqa: E501
        ...
        :param async_req bool
        :param str request_id: Unique identifier of a Compass request. (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def session_cache_options(self, **kwargs):  # noqa: E501
        """session_cache_options  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.session_cache_options(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.session_cache_options_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.session_cache_options_with_http_info(**kwargs)  # noqa: E501
            return data

    def session_cache_options_with_http_info(self, **kwargs):  # noqa: E501
        """session_cache_options  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.session_cache_options_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method session_cache_options" % key
                )
            params[key] = val
        del params['kwargs']
    ...
    def session_cache_username_options(self, username, **kwargs):  # noqa: E501
        """session_cache_username_options  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.session_cache_username_options(username, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str username: CEC username (required)
        :return: None
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.session_cache_username_options_with_http_info(username, **kwargs)  # noqa: E501
        else:
            (data) = self.session_cache_username_options_with_http_info(username, **kwargs)  # noqa: E501
            return data

    def session_cache_username_options_with_http_info(self, username, **kwargs):  # noqa: E501
        """session_cache_username_options  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.session_cache_username_options_with_http_info(username, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method session_cache_username_options" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('username' not in params or
            ...
            raise ValueError("Missing the required parameter `username` when calling `session_cache_username_options`")  # noqa: E501
    ...
    def user_info_unsubscribed_options(self, **kwargs):  # noqa: E501
        """user_info_unsubscribed_options  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.user_info_unsubscribed_options(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.user_info_unsubscribed_options_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.user_info_unsubscribed_options_with_http_info(**kwargs)  # noqa: E501
            return data

    def user_info_unsubscribed_options_with_http_info(self, **kwargs):  # noqa: E501
        """user_info_unsubscribed_options  # noqa: E501

        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.user_info_unsubscribed_options_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method user_info_unsubscribed_options" % key
                )
            params[key] = val
        del params['kwargs']
