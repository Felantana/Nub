...
class UserInfoApi(object):
    ...
    def get_user_info(self, **kwargs):  # noqa: E501
        """Get your User Info  # noqa: E501

        Get information about a user.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_user_info(async_req=False)
        >>> result = thread.get()
    ...
    def patch_user_info(self, body, **kwargs):  # noqa: E501
        """Update your User Info (Internal Only)  # noqa: E501

        Patch information about a user.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.patch_user_info(body, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param object body: A JSON object containing patch user information. (required)
        :return: UserInfo
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.patch_user_info_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.patch_user_info_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def patch_user_info_with_http_info(self, body, **kwargs):  # noqa: E501
        """Update your User Info (Internal Only)  # noqa: E501

        Patch information about a user.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.patch_user_info_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `patch_user_info`")  # noqa: E501
